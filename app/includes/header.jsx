    ...
    <>
      ...
      <header className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between py-4">
          ...
          {/* Navegação */}
          <nav
            className={`absolute md:relative top-[80px] left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none p-5 md:p-0 md:flex space-x-8 text-lg font-medium transition-all duration-300 ${menuOpen ? "block" : "hidden md:flex"
              }`}
          >
